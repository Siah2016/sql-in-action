...
-- EXPECTED OUTPUT: 146
SELECT count(host_name) as count_host FROM final_airbnb;
...
SELECT price from final_airbnb
order by price asc
limit 1;
...
SELECT avg(availability_365) as average_availability_365 from final_airbnb;
...
I think entire home and apartment are the way to go because of the fact that most people want something they can relate to. Putting a good price on the property makes a different as well, somthing that they can afford and appreciate goes a long way.
